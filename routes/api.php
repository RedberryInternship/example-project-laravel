...
Route::group(['prefix' => 'app/V1'], function () {
	...
	Route::group(['middleware' => ['jwt.verify', 'check.user.existence']], function () {
		Route::group(['namespace' => 'Api\app\V1'], function () {
			...
			Route::post('/delete-user-car', 'User\CarController@destroy'); /** !!! Deprecated !!! */
			Route::delete('/delete-user-car', 'User\CarController@destroy'); 
			...
			Route::post('/update-user-info', 'UserController@postUpdateUserInfo'); /** !!! Deprecated !!! */
			Route::put('/update-user-info', 'UserController@postUpdateUserInfo');
		
			Route::post('/update-firebase-token', 'User\FirebaseTokenController@update'); /** !!! Deprecated !!! */
			Route::put('/update-firebase-token', 'User\FirebaseTokenController@update'); 
